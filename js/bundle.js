...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({contaner, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}){
    //SLIDER
    
    const 	slides = document.querySelectorAll(slide),
        slider = document.querySelector(contaner),
    ...
    changeSliderCurrentNumber(slideIndex);
    ...
    function changeSliderCurrentNumber(slideIndex){
    if(slideIndex < 10){
    current.textContent = `0${slideIndex}`;
    }else{
    current.textContent = slideIndex;
    ...
    function activateSliderDot(slideIndex){
